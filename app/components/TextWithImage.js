  ...
  return (
    <div className="py-14 container">
      <div className="p-4 rounded relative">
        <div className="rounded mb-20 relative">
          <Image
        ...
        <p className="mb-4 before:mb-1 before:mr-2 before:inline-block before:content-[''] before:w-16 before:bg-primary before:rounded before:h-[3px]">
          ...
          een bijzonder symbool onze specialiteit. Of het nu een
          herinneringssieraad betreft met overlijden, een geboorte of voor de
          bevestiging van een relatie. Wij zijn de specialist om je daar bij van
          dienst te kunnen zijn. Er zijn veel mogelijkheden toepasbaar om jou
